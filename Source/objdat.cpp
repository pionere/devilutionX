...
/*OBJ_BOOKSHELFL*/// { OFILE_BHELF,    0,                                         THEME_NONE,              Q_INVALID,           1,            0, OPF_NONE,   OMF_FLOOR,              FALSE,     ODT_NONE,         0, FALSE,    FALSE,     ALIGN },
...
/*OBJ_STORYBOOK*/    { OFILE_BOOK1,    DTM_CATHEDRAL | DTM_CATACOMBS | DTM_CAVES, THEME_NONE,              Q_INVALID,           4,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         3, FALSE,    FALSE,     ALIGN }, // BUGFIX should only be loaded on level 1-12 (crypt masks as 1-4) (fixed)
...
/*OBJ_BOOKSHELFR*/// { OFILE_BHELF,    0,                                         THEME_NONE,              Q_INVALID,           2,            0, OPF_NONE,   OMF_FLOOR,              FALSE,     ODT_NONE,         0, FALSE,    FALSE,     ALIGN },
#ifdef HELLFIRE
