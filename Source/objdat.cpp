...
const ObjectData objectdata[NUM_OBJECTS] = {
	// clang-format off
//                     ofindex,        oLvlTypes,                                 otheme,                  oquest,     oAnimBaseFrame, oLightRadius, oProc,      oModeFlags,             oMissFlag, oDoorFlag, oSelFlag, oPreFlag, oTrapFlag, 
...
/*OBJ_CRUXM*/        { OFILE_CRUXSK1,  0,                                         THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, FALSE,     ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
/*OBJ_CRUXR*/        { OFILE_CRUXSK2,  0,                                         THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, FALSE,     ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
/*OBJ_CRUXL*/        { OFILE_CRUXSK3,  0,                                         THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, FALSE,     ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
...
/*OBJ_SARC*/         { OFILE_SARC,     DTM_CATHEDRAL,                             THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         3, FALSE,    TRUE,      ALIGN },
/*OBJ_FLAMEHOLE*///  { OFILE_FLAME1,   0,                                         THEME_NONE,              Q_INVALID,               1,            0, OPF_FLTRP,  OMF_FLOOR,              TRUE,      ODT_NONE,         0, FALSE,    FALSE,     ALIGN },
...
/*OBJ_BARREL*/       { OFILE_BARREL,   DTM_ANY & ~(DTM_CRYPT | DTM_NEST),         THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
/*OBJ_BARRELEX*/     { OFILE_BARRELEX, DTM_ANY & ~(DTM_CRYPT | DTM_NEST),         THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
/*OBJ_SHRINEL*/      { OFILE_LSHRINEG, 0,                                         THEME_SHRINE,            Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         3, TRUE,     FALSE,     ALIGN },
/*OBJ_SHRINER*/      { OFILE_RSHRINEG, 0,                                         THEME_SHRINE,            Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         3, TRUE,     FALSE,     ALIGN },
...
/*OBJ_CAULDRON*/     { OFILE_CAULDREN, DTM_HELL,                                  THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, FALSE,     ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
...
/*OBJ_L5SARC*/       { OFILE_L5SARCO,  DTM_CRYPT,                                 THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         3, FALSE,    TRUE,      ALIGN },
/*OBJ_URN*/          { OFILE_URN,      DTM_CRYPT,                                 THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
/*OBJ_URNEX*/        { OFILE_URNEXPLD, DTM_CRYPT,                                 THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
...
/*OBJ_POD*/          { OFILE_L6POD1,   DTM_NEST,                                  THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
/*OBJ_PODEX*/        { OFILE_L6POD2,   DTM_NEST,                                  THEME_NONE,              Q_INVALID,               1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
#endif
	// clang-format on
};
