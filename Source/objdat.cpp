...
/*OBJ_TCHEST1*/      { OFILE_CHEST1,   DTM_ANY,                                   THEME_NONE,              Q_INVALID,           1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         1, FALSE,    FALSE,     ALIGN },
/*OBJ_TCHEST2*/      { OFILE_CHEST2,   DTM_ANY,                                   THEME_NONE,              Q_INVALID,           1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         1, FALSE,    FALSE,     ALIGN },
/*OBJ_TCHEST3*/      { OFILE_CHEST3,   DTM_ANY,                                   THEME_NONE,              Q_INVALID,           1,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, TRUE,      ODT_NONE,         1, FALSE,    FALSE,     ALIGN },
...
/*OFILE_ROCKSTAN*/ { "Rockstan", SFX_NONE,          0, OAM_LOOP,              1,       10, TRUE,       OBM_UNBREAKABLE, ALIGN },
