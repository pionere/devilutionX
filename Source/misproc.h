...
//int AddFireball(int mi, POS32 dp, int midir, int micaster, int misource, int spllvl);
...
//int AddFlare(int mi, POS32 dp, int midir, int micaster, int misource, int spllvl);
