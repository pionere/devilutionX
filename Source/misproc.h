...
//int AddFireball(int mi, int dx, int dy, int midir, int micaster, int misource, int spllvl);
...
//int AddFlare(int mi, int dx, int dy, int midir, int micaster, int misource, int spllvl);
