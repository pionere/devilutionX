...
const SpellData spelldata[NUM_SPELLS] = {
	// clang-format off
	// sName,    sManaCost, sType,           sIcon,   sNameText,            sBookLvl, sStaffLvl, sScrollLvl, sSkillFlags,     scCurs,             spCurs,             sUseFlags,                sMinInt, sSFX,        sMissile,   sManaAdj, sMinMana, sStaffMin, sStaffMax, sBookCost, sStaffCost
