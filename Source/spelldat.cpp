...
const SpellData spelldata[NUM_SPELLS] = {
	// clang-format off
// spell_id      sManaCost, sType,           sIcon,   sNameText,            sBookLvl, sStaffLvl, sScrollLvl, sSkillFlags,     scCurs,             spCurs,             sUseFlags,                sMinInt, sSFX,        sMissile,   sManaAdj, sMinMana, sStaffMin, sStaffMax, sBookCost, sStaffCost
...
/*SPL_PIERCE_SHOT*/ {    2, STYPE_NONE,      20,      "Pierce Shot",              14,  SPELL_NA,   SPELL_NA, 0,               CURSOR_NONE,        CURSOR_NONE,        SFLAG_DUNGEON | SFLAG_RANGED,   0, 0,           MIS_ASARROW,       0,        2,         0,         0,     16000,          0, ALIGN64 },
...
/*SPL_FIREBOLT*/    {    6, STYPE_FIRE,      1,       "Firebolt",                  1,         2,   SPELL_NA, SDFLAG_TARGETED, CURSOR_NONE,        CURSOR_NONE,        SFLAG_DUNGEON,                 15, IS_CAST2,    MIS_FIREBOLT,      1,        3,        40,        80,      1000,         50, ALIGN64 },
/*SPL_CBOLT*/       {    6, STYPE_LIGHTNING, 39,      "Charged Bolt",              1,         2,   SPELL_NA, SDFLAG_TARGETED, CURSOR_NONE,        CURSOR_NONE,        SFLAG_DUNGEON,                 25, IS_CAST2,    MIS_CBOLTC,        1,        4,        40,        80,      1000,         50, ALIGN64 },
/*SPL_HBOLT*/       {    7, STYPE_MAGIC,     42,      "Acidbolt",                  1,         2,   SPELL_NA, SDFLAG_TARGETED, CURSOR_NONE,        CURSOR_NONE,        SFLAG_DUNGEON,                 20, IS_CAST2,    MIS_HBOLT,         1,        4,        40,        80,      1000,         50, ALIGN64 },
/*SPL_LIGHTNING*/   {   15, STYPE_LIGHTNING, 3,       "Lightning",                 4,         6,          4, SDFLAG_TARGETED, CURSOR_TELEPORT,    CURSOR_NONE,        SFLAG_DUNGEON,                 20, IS_CAST4,    MIS_LIGHTNINGC,    1,        8,        20,        60,      3000,        150, ALIGN64 },
...
/*SPL_BLOODBOIL*/   {   40, STYPE_MAGIC,     23,      "Bloodboil",                28,        36,         20, SDFLAG_TARGETED, CURSOR_TELEPORT,    CURSOR_NONE,        SFLAG_DUNGEON,                 50, IS_CAST2,    MIS_BLOODBOILC,    1,       30,        20,        60,     16000,        700, ALIGN64 },
...
/*SPL_INFERNO*/     {   11, STYPE_FIRE,      15,      "Inferno",                   3,         4,          1, SDFLAG_TARGETED, CURSOR_TELEPORT,    CURSOR_NONE,        SFLAG_DUNGEON,                 20, IS_CAST2,    MIS_INFERNOC,      1,        6,        20,        40,      2000,        100, ALIGN64 },
...
/*SPL_POISON*/      {   22, STYPE_MAGIC,     25,      "Posion",                   18,        28,   SPELL_NA, SDFLAG_TARGETED, CURSOR_NONE,        CURSOR_NONE,        SFLAG_DUNGEON,                 70, IS_CAST2,    MIS_POISON,        1,       18,        20,        60,     24500,       1500, ALIGN64 },
...
/*SPL_MANASHIELD*/  {   33, STYPE_MAGIC,     13,      "Mana Shield",               6,        10,          8, 0,               CURSOR_NONE,        CURSOR_NONE,        SFLAG_ANY,                     25, IS_CAST2,    MIS_MANASHIELD,    0,       33,         4,        10,     16000,       1200, ALIGN64 },
/*SPL_ATTRACT*/     {    4, STYPE_LIGHTNING, 30,      "Attract",                   2,         4,          4, SDFLAG_TARGETED, CURSOR_TELEPORT,    CURSOR_NONE,        SFLAG_DUNGEON,                 20, IS_CAST4,    MIS_ATTRACT,       0,        4,        40,        80,      2000,        200, ALIGN64 },
...
/*SPL_TELEPORT*/    {   35, STYPE_MAGIC,     24,      "Teleport",                 14,        24,         14, SDFLAG_TARGETED, CURSOR_TELEPORT,    CURSOR_NONE,        SFLAG_ANY,                    105, IS_CAST6,    MIS_TELEPORT,      5,       15,        16,        32,     20000,       1250, ALIGN64 },
/*SPL_RNDTELEPORT*/ {   11, STYPE_MAGIC,     28,      "Phasing",                   7,        12,          6, 0,               CURSOR_NONE,        CURSOR_NONE,        SFLAG_DUNGEON,                 39, IS_CAST2,    MIS_RNDTELEPORT,   1,        4,        40,        80,      3500,        200, ALIGN64 },
/*SPL_TOWN*/        {   35, STYPE_MAGIC,     7,       "Town Portal",               3,         6,          4, SDFLAG_TARGETED, CURSOR_TELEPORT,    CURSOR_NONE,        SFLAG_DUNGEON,                 20, IS_CAST6,    MIS_TOWN,          3,       18,         8,        12,      3000,        200, ALIGN64 },
...
/*SPL_RESURRECT*/   {    0, STYPE_MAGIC,     41,      "Resurrect",          SPELL_NA,        10,          1, SDFLAG_TARGETED, CURSOR_RESURRECT,   CURSOR_RESURRECT,   SFLAG_ANY,                     20, IS_CAST8,    MIS_RESURRECT,     0,        0,         4,        10,      4000,        250, ALIGN64 },
...
/*SPL_DISARM*/      {    0, STYPE_MAGIC,     37,      "Trap Disarm",        SPELL_NA,  SPELL_NA,          1, SDFLAG_TARGETED, CURSOR_DISARM,      CURSOR_DISARM,      SFLAG_DUNGEON,                 20, IS_CAST6,    MIS_DISARM,        0,        0,         0,         0,         0,         75, ALIGN64 },
#ifdef HELLFIRE
...
/*SPL_FIRERING*/    {   28, STYPE_FIRE,      49,      "Ring of Fire",              5,        10,   SPELL_NA, 0,               CURSOR_NONE,        CURSOR_NONE,        SFLAG_DUNGEON,                 27, IS_CAST2,    MIS_FIRERING,      3,       16,         8,        16,      6000,        400, ALIGN64 },
...
/*SPL_RUNEWAVE*/    {    0, STYPE_FIRE,      14,      "Wave",               SPELL_NA,  SPELL_NA,          7, SDFLAG_TARGETED, CURSOR_TELEPORT,    CURSOR_TELEPORT,    SFLAG_DUNGEON,                 42, IS_CAST8,    MIS_RUNEWAVE,      0,        0,         0,         0,         0,        500, ALIGN64 },
/*SPL_RUNESTONE*/   {    0, STYPE_MAGIC,      8,      "Stone",              SPELL_NA,  SPELL_NA,          7, SDFLAG_TARGETED, CURSOR_TELEPORT,    CURSOR_TELEPORT,    SFLAG_DUNGEON,                 25, IS_CAST8,    MIS_RUNESTONE,     0,        0,         0,         0,         0,        300, ALIGN64 },
#endif
	// clang-format on
};
