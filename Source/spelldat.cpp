...
SpellData spelldata[NUM_SPELLS] = {
	...
	{ SPL_NULL,          0, 0,               NULL,                 SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_TELEKINESIS, FALSE,            0, 0,        0,                 0,        0,        40,        80,         0,          0 },
	...
	{ SPL_IDENTIFY,     13, STYPE_MAGIC,     "Identify",           SPELL_NA,  SPELL_NA,   SCRL_MIN, FALSE,     CURSOR_IDENTIFY,    CURSOR_IDENTIFY,    TRUE,            20, IS_CAST6, MIS_IDENTIFY,      2,        1,         8,        12,         0,        100 },
...
#ifdef SPAWN
	{ SPL_STONE,        60, STYPE_MAGIC,     "Stone Curse",        SPELL_NA,  SPELL_NA,          6, TRUE,      CURSOR_TELEPORT,    CURSOR_NONE,        FALSE,           51, IS_CAST2, MIS_STONE,         3,       40,         8,        16,     12000,        800 },
#else
	...
	{ SPL_DOOMSERP,      0, STYPE_LIGHTNING, "Doom Serpents",      SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,            0, IS_CAST2, 0,                 0,        0,        40,        80,         0,          0 },
	{ SPL_BLODRIT,       0, STYPE_MAGIC,     "Blood Ritual",       SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,            0, IS_CAST2, 0,                 0,        0,        40,        80,         0,          0 },
#ifdef HELLFIRE
...
#endif
	{ SPL_INVISIBIL,     0, STYPE_MAGIC,     "Invisibility",       SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,            0, IS_CAST2, 0,                 0,        0,        40,        80,         0,          0 },
...
#ifdef SPAWN
	{ SPL_GOLEM,       100, STYPE_FIRE,      "Golem",              SPELL_NA,  SPELL_NA,         10, TRUE,      CURSOR_TELEPORT,    CURSOR_NONE,        FALSE,           81, IS_CAST2, MIS_GOLEM,         6,       60,        16,        32,     18000,       1100 },
#else
...
#endif
#ifdef HELLFIRE
	{ SPL_BLODBOIL,     15, STYPE_MAGIC,     "Rage",               SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,            0, IS_CAST8, MIS_BLODBOIL,      1,        1,         0,         0,         0,          0 },
#else
...
#ifdef SPAWN
	{ SPL_APOCA,       150, STYPE_FIRE,      "Apocalypse",         SPELL_NA,  SPELL_NA,         22, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,          149, IS_CAST2, MIS_APOCAC,        6,       90,         8,        12,     30000,       2000 },
#elif defined(HELLFIRE)
	{ SPL_APOCA,       150, STYPE_FIRE,      "Apocalypse",               19,        30,         22, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,          149, IS_CAST2, MIS_APOCAC,        6,       90,         8,        12,     30000,       2000 },
#else
	{ SPL_APOCA,       150, STYPE_FIRE,      "Apocalypse",         SPELL_NA,        30,         22, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,          149, IS_CAST2, MIS_APOCAC,        6,       90,         8,        12,     30000,       2000 },
#endif
	{ SPL_ETHEREALIZE, 100, STYPE_MAGIC,     "Etherealize",        SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,           93, IS_CAST2, MIS_ETHEREALIZE,   0,      100,         2,         6,     26000,       1600 },
	{ SPL_REPAIR,        0, STYPE_MAGIC,     "Item Repair",        SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_REPAIR,      CURSOR_REPAIR,      TRUE,             0, IS_CAST6, MIS_REPAIR,        0,        0,        40,        80,         0,          0 },
	...
	{ SPL_RESURRECT,    20, STYPE_MAGIC,     "Resurrect",          SPELL_NA,        10,   SCRL_MIN, TRUE,      CURSOR_RESURRECT,   CURSOR_RESURRECT,   TRUE,            20, IS_CAST8, MIS_RESURRECT,     0,       20,         4,        10,      4000,        250 },
...
#ifdef SPAWN
	{ SPL_FLARE,        25, STYPE_MAGIC,     "Blood Star",         SPELL_NA,  SPELL_NA,   SPELL_NA, TRUE,      CURSOR_NONE,        CURSOR_NONE,        FALSE,           70, IS_CAST2, MIS_FLARE,         2,       14,        20,        60,     27500,       1800 },
	{ SPL_BONESPIRIT,   24, STYPE_MAGIC,     "Bone Spirit",        SPELL_NA,  SPELL_NA,   SPELL_NA, TRUE,      CURSOR_NONE,        CURSOR_NONE,        FALSE,           34, IS_CAST2, MIS_BONESPIRIT,    1,       12,        20,        60,     11500,        800 },
#else
	...
	{ SPL_BONESPIRIT,   24, STYPE_MAGIC,     "Bone Spirit",               9,        14,   SPELL_NA, TRUE,      CURSOR_NONE,        CURSOR_NONE,        FALSE,           34, IS_CAST2, MIS_BONESPIRIT,    1,       12,        20,        60,     11500,        800 },
#endif
#ifdef HELLFIRE
	{ SPL_MANA,        255, STYPE_MAGIC,     "Mana",               SPELL_NA,        10,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        TRUE,            17, IS_CAST8, MIS_MANA,          3,        1,        12,        24,      1000,         50 },
	{ SPL_MAGI,        255, STYPE_MAGIC,     "the Magi",           SPELL_NA,        40,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        TRUE,            45, IS_CAST8, MIS_MAGI,          3,        1,        15,        30,    100000,        200 },
	{ SPL_JESTER,      255, STYPE_MAGIC,     "the Jester",         SPELL_NA,         8,   SPELL_NA, TRUE,      CURSOR_TELEPORT,    CURSOR_NONE,        FALSE,           30, IS_CAST8, MIS_JESTER,        3,        1,        15,        30,    100000,        200 },
	...
	{ SPL_WARP,         35, STYPE_MAGIC,     "Warp",                      3,         6,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,           25, IS_CAST6, MIS_WARP,          3,       18,         8,        12,      3000,        200 },
	{ SPL_REFLECT,      35, STYPE_MAGIC,     "Reflect",                   3,         6,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,           25, IS_CAST6, MIS_REFLECT,       3,       15,         8,        12,      3000,        200 },
	{ SPL_BERSERK,      35, STYPE_MAGIC,     "Berserk",                   3,         6,   SPELL_NA, TRUE,      CURSOR_TELEPORT,    CURSOR_NONE,        FALSE,           35, IS_CAST6, MIS_BERSERK,       3,       15,         8,        12,      3000,        200 },
	...
	{ SPL_SEARCH,       15, STYPE_MAGIC,     "Search",             BOOK_MIN,         6,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,           25, IS_CAST6, MIS_SEARCH,        1,        1,         8,        12,      3000,        200 },
	{ SPL_RUNEFIRE,    255, STYPE_MAGIC,     "Rune of Fire",       SPELL_NA,  SPELL_NA,   SPELL_NA, TRUE,      CURSOR_TELEPORT,    CURSOR_TELEPORT,    FALSE,           48, IS_CAST8, MIS_RUNEFIRE,      1,       10,        40,        80,      8000,        300 },
	{ SPL_RUNELIGHT,   255, STYPE_MAGIC,     "Rune of Light",      SPELL_NA,  SPELL_NA,   SPELL_NA, TRUE,      CURSOR_TELEPORT,    CURSOR_TELEPORT,    FALSE,           48, IS_CAST8, MIS_RUNELIGHT,     1,       10,        40,        80,      8000,        300 },
	{ SPL_RUNENOVA,    255, STYPE_MAGIC,     "Rune of Nova",       SPELL_NA,  SPELL_NA,   SPELL_NA, TRUE,      CURSOR_TELEPORT,    CURSOR_TELEPORT,    FALSE,           48, IS_CAST8, MIS_RUNENOVA,      1,       10,        40,        80,      8000,        300 },
