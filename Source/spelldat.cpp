...
SpellData spelldata[NUM_SPELLS] = {
	...
	{ SPL_DOOMSERP,      0, STYPE_LIGHTNING, "Doom Serpents",      SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,            0, IS_CAST2, 0,                 0,        0,         0,         0,         0,          0 },
	{ SPL_BLODRIT,       0, STYPE_MAGIC,     "Blood Ritual",       SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        FALSE,            0, IS_CAST2, 0,                 0,        0,         0,         0,         0,          0 },
#ifdef HELLFIRE
...
#endif
#ifdef HELLFIRE
	{ SPL_MANA,        255, STYPE_MAGIC,     "Mana",               SPELL_NA,        10,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        TRUE,            17, IS_CAST8, MIS_MANA,          0,        0,        12,        24,      1000,         50 },
	{ SPL_MAGI,        255, STYPE_MAGIC,     "the Magi",           SPELL_NA,        40,   SPELL_NA, FALSE,     CURSOR_NONE,        CURSOR_NONE,        TRUE,            45, IS_CAST8, MIS_MAGI,          0,        0,        15,        30,    100000,        200 },
	{ SPL_JESTER,      255, STYPE_MAGIC,     "the Jester",         SPELL_NA,         8,   SPELL_NA, TRUE,      CURSOR_TELEPORT,    CURSOR_NONE,        FALSE,           30, IS_CAST8, MIS_JESTER,        0,        0,        15,        30,    100000,        200 },
