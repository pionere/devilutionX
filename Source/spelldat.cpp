...
const SpellData spelldata[NUM_SPELLS] = {
	...
	{ SPL_IDENTIFY,      0, STYPE_MAGIC,     5,       "Identify",           SPELL_NA,  SPELL_NA,          1, FALSE,     CURSOR_IDENTIFY,    CURSOR_IDENTIFY,    SFLAG_ANY,                     20, IS_CAST6,    MIS_IDENTIFY,      0,        0,         0,         0,         0,        100 },
...
#ifdef HELLFIRE
	{ SPL_BUCKLE,        0, STYPE_MAGIC,     26,      "Shield Buckle",      SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_IDENTIFY,    CURSOR_IDENTIFY,    SFLAG_ANY,                      0, IS_CAST6,    MIS_ABILITY,       0,        0,         0,         0,         0,          0 },
	{ SPL_WHITTLE,       0, STYPE_MAGIC,     29,      "Staff Whittle",      SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_RECHARGE,    CURSOR_RECHARGE,    SFLAG_ANY,                      0, IS_CAST6,    MIS_ABILITY,       0,        0,         0,         0,         0,          0 },
