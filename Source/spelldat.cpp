...
const SpellData spelldata[NUM_SPELLS] = {
	...
	{ SPL_HBOLT,         7, STYPE_MAGIC,     42,      "Acidbolt",                  1,         2,   SPELL_NA, TRUE,      CURSOR_TELEPORT,    CURSOR_NONE,        SFLAG_DUNGEON,                 20, IS_CAST2,    MIS_HBOLT,         1,        4,        40,        80,      1000,         50 },
	...
	{ SPL_CHAIN,        30, STYPE_LIGHTNING, 16,      "Chain Lightning",           8,        14,         10, TRUE,      CURSOR_NONE,        CURSOR_NONE,        SFLAG_DUNGEON,                 54, IS_CAST2,    MIS_CHAIN,         2,       18,        20,        60,     11000,        750 },
	{ SPL_WAVE,         35, STYPE_FIRE,      14,      "Fire Wave",                 9,        16,         10, TRUE,      CURSOR_TELEPORT,    CURSOR_NONE,        SFLAG_DUNGEON,                 54, IS_CAST2,    MIS_FIREWAVEC,     4,       20,        20,        40,     10000,        650 },
	...
	{ SPL_INFERNO,      11, STYPE_FIRE,      15,      "Inferno",                   3,         4,          1, TRUE,      CURSOR_TELEPORT,    CURSOR_NONE,        SFLAG_DUNGEON,                 20, IS_CAST2,    MIS_INFERNOC,      1,        6,        20,        40,      2000,        100 },
	{ SPL_ELEMENTAL,    35, STYPE_FIRE,      38,      "Elemental",                 8,        12,   SPELL_NA, TRUE,      CURSOR_NONE,        CURSOR_NONE,        SFLAG_DUNGEON,                 68, IS_CAST2,    MIS_ELEMENTAL,     4,       20,        20,        60,     10500,        700 },
	...
	{ SPL_HEAL,          5, STYPE_MAGIC,     2,       "Healing",                   1,         2,          1, FALSE,     CURSOR_NONE,        CURSOR_NONE,        SFLAG_ANY,                     17, IS_CAST8,    MIS_HEAL,          6,        1,        20,        40,      1000,         50 },
	{ SPL_HEALOTHER,     5, STYPE_MAGIC,     10,      "Heal Other",                1,         2,   SPELL_NA, TRUE,      CURSOR_HEALOTHER,   CURSOR_HEALOTHER,   SFLAG_ANY,                     17, IS_CAST8,    MIS_HEALOTHER,     6,        1,        20,        40,      1000,         50 },
	{ SPL_RESURRECT,     0, STYPE_MAGIC,     41,      "Resurrect",          SPELL_NA,        10,          1, TRUE,      CURSOR_RESURRECT,   CURSOR_RESURRECT,   SFLAG_ANY,                     20, IS_CAST8,    MIS_RESURRECT,     0,        0,         4,        10,      4000,        250 },
	{ SPL_IDENTIFY,      0, STYPE_MAGIC,     5,       "Identify",           SPELL_NA,  SPELL_NA,          1, FALSE,     CURSOR_IDENTIFY,    CURSOR_IDENTIFY,    SFLAG_ANY,                     20, IS_CAST6,    MIS_OPITEM,        0,        0,         0,         0,         0,        100 },
	{ SPL_OIL,           0, STYPE_MAGIC,     5,       NULL,                 SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_OIL,         CURSOR_OIL,         SFLAG_ANY,                      0, IS_CAST6,    MIS_OPITEM,        0,        0,         0,         0,         0,          0 },
	{ SPL_REPAIR,        0, STYPE_MAGIC,     26,      "Item Repair",        SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_REPAIR,      CURSOR_REPAIR,      SFLAG_ANY,                      0, SFX_SILENCE, MIS_REPAIR,        0,        0,         0,         0,         0,          0 },
	{ SPL_RECHARGE,      0, STYPE_MAGIC,     29,      "Staff Recharge",     SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_RECHARGE,    CURSOR_RECHARGE,    SFLAG_ANY,                      0, IS_CAST6,    MIS_OPITEM,        0,        0,         0,         0,         0,          0 },
...
#ifdef HELLFIRE
	{ SPL_BUCKLE,        0, STYPE_MAGIC,     26,      "Shield Buckle",      SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_IDENTIFY,    CURSOR_IDENTIFY,    SFLAG_ANY,                      0, IS_CAST6,    MIS_OPITEM,        0,        0,         0,         0,         0,          0 },
	{ SPL_WHITTLE,       0, STYPE_MAGIC,     29,      "Staff Whittle",      SPELL_NA,  SPELL_NA,   SPELL_NA, FALSE,     CURSOR_RECHARGE,    CURSOR_RECHARGE,    SFLAG_ANY,                      0, IS_CAST6,    MIS_OPITEM,        0,        0,         0,         0,         0,          0 },
	...
	{ SPL_RUNELIGHT,     0, STYPE_MAGIC,     35,      "Rune of Lightning",  SPELL_NA,  SPELL_NA,   SPELL_NA, TRUE,      CURSOR_TELEPORT,    CURSOR_TELEPORT,    SFLAG_DUNGEON,                 48, IS_CAST8,    MIS_RUNELIGHT,     0,        0,         0,         0,      8000,        300 },
	...
	{ SPL_RUNEWAVE,      0, STYPE_MAGIC,     35,      "Rune of Wave",       SPELL_NA,  SPELL_NA,   SPELL_NA, TRUE,      CURSOR_TELEPORT,    CURSOR_TELEPORT,    SFLAG_DUNGEON,                 48, IS_CAST8,    MIS_RUNEWAVE,      0,        0,         0,         0,      8000,        300 },
