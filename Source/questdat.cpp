...
/*DLV_CATHEDRAL1*/	{       2, FALSE,   DTYPE_CATHEDRAL, DGT_CATHEDRAL, TMUSIC_L1,    LFILE_L1,            10,      10, "Cathedral 1",
						"Levels\\L1Data\\L1_%d.PAL",     "Gendata\\Cutl1d.CEL",   "Gendata\\Cutl1d.pal",            TRUE,           138, 34,          32,          0,             0,                        WRPT_NONE,    SPT_NONE,
...
/*DLV_CATACOMBS1*/	{      10, FALSE,   DTYPE_CATACOMBS, DGT_CATACOMBS, TMUSIC_L2,    LFILE_L2,            10,      10, "Catacombs 1",
						"Levels\\L2Data\\L2_%d.PAL",     "Gendata\\Cut2.CEL",     "Gendata\\Cut2.pal",              TRUE,           254, 34,          32,          0,             0,                        WRPT_NONE,    SPT_NONE,
...
/*DLV_CAVES1*/		{      18, FALSE,   DTYPE_CAVES,     DGT_CAVES,     TMUSIC_L3,     LFILE_L3,           10,      10, "Caves 1",
						"Levels\\L3Data\\L3_%d.PAL",     "Gendata\\Cut3.CEL",     "Gendata\\Cut3.pal",             FALSE,            43, 34,          32,          0,             0,                        WRPT_NONE,    SPT_NONE,
...
/*DLV_HELL1*/		{      26, FALSE,   DTYPE_HELL,      DGT_HELL,      TMUSIC_L4,     LFILE_L4,           12,      16, "Hell 1",
						"Levels\\L4Data\\L4_%d.PAL",     "Gendata\\Cut4.CEL",     "Gendata\\Cut4.pal",             FALSE,            43, 34,          32,          0,             0,                        WRPT_NONE,    SPT_NONE,
...
/*DLV_HELL2*/		{      28, FALSE,   DTYPE_HELL,      DGT_HELL,      TMUSIC_L4,     LFILE_L4,           12,      16, "Hell 2",
						"Levels\\L4Data\\L4_%d.PAL",     "Gendata\\Cut4.CEL",     "Gendata\\Cut4.pal",             FALSE,            43, 34,          32,          0,             0,                        WRPT_NONE,    SPT_NONE,
						{ MT_RSNAKE, MT_NBLACK, MT_NSUCC, MT_BMEGA, MT_XACID, MT_GTHIN, MT_RMEGA, MT_BSNAKE, MT_RBLACK, MT_GBLACK, MT_GSUCC, MT_NMAGE, MT_GMAGE, MT_BBLACK, MT_RSUCC, MT_INVALID },
					},
/*DLV_HELL3*/		{      30, FALSE,   DTYPE_HELL,      DGT_HELL,      TMUSIC_L4,     LFILE_L4,           12,      16, "Hell 3",
						"Levels\\L4Data\\L4_%d.PAL",     "Gendata\\Cut4.CEL",     "Gendata\\Cut4.pal",             FALSE,            43, 34,          32,          0,             0,                        WRPT_NONE,    SPT_NONE,
						{ MT_RMEGA, MT_RBLACK, MT_GSUCC, MT_GMAGE, MT_BBLACK, MT_RSUCC, MT_GSNAKE, MT_BSUCC, MT_XMAGE, MT_INVALID },
					},
/*DLV_HELL4*/		{      32, FALSE,   DTYPE_HELL,      DGT_HELL,      TMUSIC_L4,     LFILE_L4,           12,      16, "Diablo",
						"Levels\\L4Data\\L4_%d.PAL",     "Gendata\\Cutgate.CEL",  "Gendata\\Cutgate.pal",          FALSE,            43, 34,          32,          0,             0,                        WRPT_NONE,    SPT_NONE,
						{ MT_INVALID }, /* MT_GBLACK, MT_BMAGE, MT_NBLACK, MT_DIABLO */
					},
#ifdef HELLFIRE
/*DLV_NEST1*/		{      18, FALSE,   DTYPE_NEST,      DGT_CAVES,     TMUSIC_L6,     LFILE_L6,           10,      10, "Nest 1",
						"NLevels\\L6Data\\L6Base%d.PAL", "Nlevels\\Cutl6.CEL",    "Nlevels\\Cutl6.pal",            FALSE,            43, 34,          32,          0,             0,                        WRPT_NONE,    SPT_NONE,
...
/*DLV_CRYPT1*/		{      26, FALSE,   DTYPE_CRYPT,     DGT_CATHEDRAL, TMUSIC_L5,     LFILE_L5,           10,      10, "Crypt 1",
						"NLevels\\L5Data\\L5Base.PAL",   "Nlevels\\Cutl5.CEL",    "Nlevels\\Cutl5.pal",            FALSE,            43, 34,          32,          0,             0,                        WRPT_NONE,    SPT_NONE,
...
/*SL_SKELKING*/		{       6, TRUE,    DTYPE_CATHEDRAL, DGT_CATHEDRAL, TMUSIC_L1,   LFILE_L1,             10,      10, "Skeleton King's Lair",
						"Levels\\L1Data\\L1_2.pal",      "Gendata\\Cutl1d.CEL",   "Gendata\\Cutl1d.pal",            TRUE,           138, 81,          0,           DBORDERX+2*33, DBORDERY+2*13,            WRPT_L1_UP,   SPT_LVL_SKELKING,
...
/*SL_POISONWATER*/	{       4, TRUE,    DTYPE_CAVES,     DGT_CAVES,     TMUSIC_L3,   LFILE_L3,             10,      10, "Poisoned Water Supply",
						"Levels\\L3Data\\L3pfoul.pal",   "Gendata\\Cutl1d.CEL",   "Gendata\\Cutl1d.pal",            TRUE,           138, 70,          0,           DBORDERX+2*7,  DBORDERY+2*33+1,          WRPT_L3_DOWN, SPT_LVL_PWATER,
...
const LevelFileData levelfiledata[NUM_LFILE_TYPES] = {
	// clang-format off
//               dAutomapData,              dTileFlags,                dSolidTable,                   dMicroFlags,                   dMicroCels,                    dMegaTiles,                    dMiniTiles,                    dSpecFlags,                    dSpecCels,                     
  
#ifdef HELLFIRE
/*LFILE_TOWN*/ { NULL,                      NULL,                      "NLevels\\TownData\\Town.SOL", "NLevels\\TownData\\Town.TMI", "NLevels\\TownData\\Town.CEL", NULL,                          "NLevels\\TownData\\Town.MIN", "NLevels\\TownData\\Town.SPT", "Levels\\TownData\\TownS.CEL" },
#else
/*LFILE_TOWN*/ { NULL,                      NULL,                      "Levels\\TownData\\Town.SOL",  "Levels\\TownData\\Town.TMI",  "Levels\\TownData\\Town.CEL",  NULL,                          "Levels\\TownData\\Town.MIN",  "Levels\\TownData\\Town.SPT",  "Levels\\TownData\\TownS.CEL" },
#endif
/*LFILE_L1*/   { "Levels\\L1Data\\L1.SMP",  "Levels\\L1Data\\L1.TLA",  "Levels\\L1Data\\L1.SOL",      "Levels\\L1Data\\L1.TMI",      "Levels\\L1Data\\L1.CEL",      "Levels\\L1Data\\L1.TIL",      "Levels\\L1Data\\L1.MIN",      "Levels\\L1Data\\L1.SPT",      "Levels\\L1Data\\L1S.CEL"     },
/*LFILE_L2*/   { "Levels\\L2Data\\L2.SMP",  "Levels\\L2Data\\L2.TLA",  "Levels\\L2Data\\L2.SOL",      "Levels\\L2Data\\L2.TMI",      "Levels\\L2Data\\L2.CEL",      "Levels\\L2Data\\L2.TIL",      "Levels\\L2Data\\L2.MIN",      "Levels\\L2Data\\L2.SPT",      "Levels\\L2Data\\L2S.CEL"     },
/*LFILE_L3*/   { "Levels\\L3Data\\L3.SMP",  "Levels\\L3Data\\L3.TLA",  "Levels\\L3Data\\L3.SOL",      "Levels\\L3Data\\L3.TMI",      "Levels\\L3Data\\L3.CEL",      "Levels\\L3Data\\L3.TIL",      "Levels\\L3Data\\L3.MIN",      "Levels\\L3Data\\L3.SPT",      NULL,                         },
/*LFILE_L4*/   { "Levels\\L4Data\\L4.SMP",  "Levels\\L4Data\\L4.TLA",  "Levels\\L4Data\\L4.SOL",      "Levels\\L4Data\\L4.TMI",      "Levels\\L4Data\\L4.CEL",      "Levels\\L4Data\\L4.TIL",      "Levels\\L4Data\\L4.MIN",      "Levels\\L4Data\\L4.SPT",      NULL,                         },
#ifdef HELLFIRE
/*LFILE_L5*/   { "NLevels\\L5Data\\L5.SMP", "NLevels\\L5Data\\L5.TLA", "NLevels\\L5Data\\L5.SOL",     "NLevels\\L5Data\\L5.TMI",     "NLevels\\L5Data\\L5.CEL",     "NLevels\\L5Data\\L5.TIL",     "NLevels\\L5Data\\L5.MIN",     "NLevels\\L5Data\\L5.SPT",     "NLevels\\L5Data\\L5S.CEL"    },
/*LFILE_L6*/   { "NLevels\\L6Data\\L6.SMP", "NLevels\\L6Data\\L6.TLA", "NLevels\\L6Data\\L6.SOL",     "NLevels\\L6Data\\L6.TMI",     "NLevels\\L6Data\\L6.CEL",     "NLevels\\L6Data\\L6.TIL",     "NLevels\\L6Data\\L6.MIN",     "NLevels\\L6Data\\L6.SPT",     NULL,                         },
#endif
	// clang-format on
};
