...
const int Qtalklist[STORE_TOWNERS][NUM_QUESTS] = {
	// clang-format off
#ifdef HELLFIRE
	// Q_BUTCHER,  Q_PWATER,      Q_SKELKING,  Q_BANNER,     Q_GARBUD,  Q_ROCK,       Q_BLOOD,     Q_SCHAMB,   Q_BLIND,     Q_ZHAR,    Q_MUSHROOM,  Q_ANVIL,      Q_WARLORD,    Q_VEIL,     Q_BETRAYER,  Q_DIABLO,   Q_JERSEY,  Q_FARMER,  Q_GIRL,    Q_DEFILER,  Q_TRADER,   Q_GRAVE,     Q_NAKRUL
...
#else
	// Q_BUTCHER,  Q_PWATER,      Q_SKELKING,  Q_BANNER,     Q_GARBUD,	Q_ROCK,       Q_BLOOD,     Q_SCHAMB,   Q_BLIND,     Q_ZHAR,    Q_MUSHROOM,  Q_ANVIL,      Q_WARLORD,    Q_VEIL,     Q_BETRAYER,  Q_DIABLO
