...
int SpellSourceInv(int sn)
{
	...
	static_assert((int)INVITEM_INV_FIRST > (int)SPLFROM_SKILL || (int)INVITEM_INV_LAST < (int)SPLFROM_SKILL, "SpellSourceInv expects the INV indices to be distinct from SPLFROM_SKILL.");
	pi = p->InvList;
	...
	static_assert((int)INVITEM_BELT_FIRST > (int)SPLFROM_SKILL || (int)INVITEM_BELT_LAST < (int)SPLFROM_SKILL, "SpellSourceInv expects the BELT indices to be distinct from SPLFROM_SKILL.");
	pi = p->SpdList;
...
int SpellSourceEquipment(int sn)
{
	...
	static_assert((int)INVITEM_HAND_LEFT != (int)SPLFROM_SKILL, "SpellSourceEquipment expects the LEFT_HAND index to be distinct from SPLFROM_SKILL.");
