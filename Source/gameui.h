...
#define SMALL_LOGO_PAGE_HEIGHT      480
#define SMALL_LOGO_TOP              (SCREEN_MIDY(SMALL_LOGO_PAGE_HEIGHT))
...
#define SELCONN_LPANEL_LEFT   (SCREEN_MIDX(640 - 25 * 2))
#define SELCONN_LPANEL_WIDTH  (228)
#define SELCONN_RPANEL_LEFT   (SCREEN_MIDX(640 - 280 * 2))
...
#define SELHERO_HEROS_LEFT     (SCREEN_MIDX(640 - 30 * 2))
...
#define SELHERO_RPANEL_LEFT    (SCREEN_MIDX(640 - 240 * 2))
...
#define SELGAME_LPANEL_LEFT   (SCREEN_MIDX(640 - 25 * 2))
...
#define SELGAME_RPANEL_LEFT   (SCREEN_MIDX(640 - 280 * 2))
