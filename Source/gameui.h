...
#define SELHERO_TITLE_TOP		(SMALL_LOGO_TOP + SMALL_LOGO_HEIGHT + 7)
...
#define SELGAME_TITLE_TOP		(SMALL_LOGO_TOP + SMALL_LOGO_HEIGHT + 7)
...
#define SELYNOK_TITLE_TOP		(SMALL_LOGO_TOP + SMALL_LOGO_HEIGHT + 7)
#define SELYNOK_CONTENT_HEIGHT	168
#define SELYNOK_CONTENT_TOP		(PANEL_TOP + SMALL_LOGO_HEIGHT + 82)
#define SELYNOK_BUTTON_TOP		(PANEL_TOP + 390)
