...
#define MANA_FLASK_X		(PANEL_X + PANEL_WIDTH - (SPLICONLENGTH + MANA_FLASK_WIDTH - MANA_FLASK_WIDTH / 20))
...
#define TALK_PNL_Y			(SCREEN_Y + PANEL_BOTTOM - 116)
#define TALK_PNL_X			PANEL_CENTERX(TALK_PNL_WIDTH)

#define PLRMSG_COUNT		32
#define PLRMSG_PANEL_BORDER	3
#define PLRMSG_TEXT_HEIGHT	12
#define PLRMSG_TEXT_X		(PANEL_X + 10)
#define PLRMSG_TEXT_BOTTOM	(TALK_PNL_Y - 14)
