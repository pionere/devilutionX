...
#define BACKGROUND_ART_LEFT   PANEL_MIDX(BACKGROUND_ART_WIDTH)
#define BACKGROUND_ART_TOP    PANEL_MIDY(BACKGROUND_ART_HEIGHT)
...
#define CREDITS_LEFT   (PANEL_MIDX(620 * ASSET_MPL))
