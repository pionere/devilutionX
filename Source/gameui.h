...
#define SELCONN_PNL_TOP			(PANEL_TOP + 211)
#define SELCONN_HEADER_HEIGHT	34
#define SELCONN_LPANEL_LEFT		(PANEL_LEFT + 25)
#define SELCONN_LPANEL_WIDTH	228
#define SELCONN_RPANEL_LEFT		(PANEL_LEFT + 280)
#define SELCONN_RPANEL_WIDTH	334
#define SELCONN_RPANEL_HEIGHT	178

#define SELHERO_PNL_TOP			(PANEL_TOP + 211)
#define SELHERO_HEROS_WIDTH		180
#define SELHERO_HEROS_HEIGHT	76
#define SELHERO_HEROS_LEFT		(PANEL_LEFT + 30)
...
#define SELHERO_RPANEL_LEFT		(PANEL_LEFT + 240)

#define SELGAME_PNL_TOP			(PANEL_TOP + 211)
#define SELGAME_HEADER_HEIGHT	34
#define SELGAME_LPANEL_LEFT		(PANEL_LEFT + 25)
#define SELGAME_LPANEL_WIDTH	228
#define SELGAME_RPANEL_LEFT		(PANEL_LEFT + 280)
