...
MonsterData monsterdata[] = {
	...
	{    160,   1010, "Monsters\\SKing\\SKing%c.CL2",     TRUE,        "Monsters\\SKing\\SKing%c%i.WAV",    TRUE,        TRUE,      "Monsters\\SkelAxe\\White.TRN",    {  8,  6, 16,  6, 16,  6 }, { 2, 0, 0, 0, 0, 2 }, "Skeleton King",            6,        6,      9,    140,    140, AI_SKELKING,                 MFLAG_LIFESTEAL | MFLAG_SEARCH | MFLAG_CAN_OPEN_DOOR,    3,   60,      8,          6,         16,     0,       0,           0,           0,          70, MC_UNDEAD,   IMMUNE_MAGIC | RESIST_FIRE | RESIST_LIGHTNING | IMMUNE_NULL_40, IMMUNE_MAGIC | IMMUNE_FIRE | IMMUNE_LIGHTNING | IMMUNE_NULL_40,    0x8001,        7,   570 },
...
#endif
	{    160,   1740, "Monsters\\Thin\\Thin%c.CL2",       TRUE,        "Monsters\\Thin\\Thin%c%i.WAV",      TRUE,        TRUE,      "Monsters\\Thin\\Thinv3.TRN",      {  8,  8, 18,  4, 17, 14 }, { 3, 0, 0, 0, 0, 0 }, "Red Storm",               17,       21,     18,     55,    110, AI_STORM2,                                     MFLAG_SEARCH | MFLAG_CAN_OPEN_DOOR,    0,   80,      5,          8,         18,    75,       8,           4,          16,          30, MC_DEMON,    IMMUNE_MAGIC |               RESIST_LIGHTNING                 , IMMUNE_MAGIC |               IMMUNE_LIGHTNING                 ,         0,        7,  2160 },
	{    160,   1740, "Monsters\\Thin\\Thin%c.CL2",       TRUE,        "Monsters\\Thin\\Thin%c%i.WAV",      TRUE,        FALSE,     NULL,                              {  8,  8, 18,  4, 17, 14 }, { 3, 0, 0, 0, 0, 0 }, "Storm Rider",             19,       23,     20,     60,    120, AI_STORM2,                                     MFLAG_SEARCH | MFLAG_CAN_OPEN_DOOR,    1,   80,      5,          8,         18,    80,       8,           4,          16,          30, MC_DEMON,    RESIST_MAGIC |               IMMUNE_LIGHTNING                 , IMMUNE_MAGIC |               IMMUNE_LIGHTNING                 ,         0,        7,  2391 },
	{    160,   1740, "Monsters\\Thin\\Thin%c.CL2",       TRUE,        "Monsters\\Thin\\Thin%c%i.WAV",      TRUE,        TRUE,      "Monsters\\Thin\\Thinv2.TRN",      {  8,  8, 18,  4, 17, 14 }, { 3, 0, 0, 0, 0, 0 }, "Storm Lord",              21,       25,     22,     75,    135, AI_STORM2,                                     MFLAG_SEARCH | MFLAG_CAN_OPEN_DOOR,    2,   85,      5,         12,         24,    75,       8,           4,          16,          35, MC_DEMON,    RESIST_MAGIC |               IMMUNE_LIGHTNING                 , IMMUNE_MAGIC |               IMMUNE_LIGHTNING                 ,         0,        7,  2775 },
	{    160,   1740, "Monsters\\Thin\\Thin%c.CL2",       TRUE,        "Monsters\\Thin\\Thin%c%i.WAV",      TRUE,        TRUE,      "Monsters\\Thin\\Thinv1.TRN",      {  8,  8, 18,  4, 17, 14 }, { 3, 0, 0, 0, 0, 0 }, "Maelstorm",               23,       27,     24,     90,    150, AI_STORM2,                                     MFLAG_SEARCH | MFLAG_CAN_OPEN_DOOR,    3,   90,      5,         12,         28,    75,       8,           4,          16,          40, MC_DEMON,    RESIST_MAGIC |               IMMUNE_LIGHTNING | IMMUNE_NULL_40, IMMUNE_MAGIC |               IMMUNE_LIGHTNING | IMMUNE_NULL_40,         0,        7,  3177 },
#ifdef HELLFIRE
	...
	{    164,    520, "Monsters\\Spawn\\Spawn%c.CL2",     FALSE,       "Monsters\\newsfx\\HSpawn%c%i.WAV",  TRUE,        FALSE,     NULL,                              { 15, 12, 14, 11, 14,  0 }, { 0, 0, 0, 0, 0, 0 }, "Hork Spawn",              34,       37,     22,     30,     30, AI_SKELSD,    0                                                                  ,    3,   60,      8,         10,         25,     0,       0,           0,           0,          25, MC_DEMON,    RESIST_MAGIC                                                  , RESIST_MAGIC                                                  ,    0x4000,        3,   250 },
...
UniqMonstStruct UniqMonst[] = {
	...
	{  MT_STORM,    "Glasskull the Jagged",     "BHKA",        7,    354, AI_STORM2,   0,         18,         30, IMMUNE_MAGIC | IMMUNE_FIRE |                    IMMUNE_NULL_40,        3,        0,        0, 0              },
	...
	{  MT_STORM,    "Brokenstorm",              "GENERAL",     9,    411, AI_STORM2,   2,         25,         36,                              IMMUNE_LIGHTNING                 ,        3,        0,        0, 0              },
	{  MT_RSTORM,   "Stormbane",                "GENERAL",     9,    555, AI_STORM2,   3,         30,         30,                              IMMUNE_LIGHTNING                 ,        3,        0,        0, 0              },
	...
	{  MT_RSTORM,   "The Flayer",               "GENERAL",    10,    501, AI_STORM2,   1,         20,         35, RESIST_MAGIC | RESIST_FIRE | IMMUNE_LIGHTNING | IMMUNE_NULL_40,        3,        0,        0, 0              },
	...
	{  MT_MAEL,     "Doomcloud",                "GENERAL",    13,    612, AI_STORM2,   1,          1,         60,                RESIST_FIRE | IMMUNE_LIGHTNING                 ,        0,        0,        0, 0              },
