...
powershell "Get-Content ..\uwp-project\Package.appxmanifest.template | %% {$_ -replace '__PROJECT_VERSION__','1.0.0.0' | Out-File -FilePath ..\uwp-project\Package.appxmanifest -encoding ASCII"
rem - build the game
