# DevilutionX (Diablo 1) for Raspberry Pi
...
2. Install libsdl2 libsdl2-mixer
3. Copy DIABDAT.MPQ from the CD or GOG-installation (or extract it from the GoG installer) to the DevilutionX folder.
